...
import { Feather, BookOpen, Terminal } from 'lucide-react';
...
export default function Home() {
  return (
    <div className="flex flex-col items-center gap-10 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl mt-4">
        ...
        {/* API Card */}
        <div className="glass-sidebar p-8 flex flex-col items-center text-center gap-4 hover:bg-[rgba(255,255,255,0.12)] transition-colors">
          <Terminal size={48} className="mb-2 text-[#d4af37]" />
          <h3 className="text-xl font-bold text-[#d4af37] uppercase tracking-widest">API Сервисъ</h3>
          <p className="opacity-80 text-sm flex-grow">
            Интегрируйте нашъ переводчикъ въ свои проекты. Бесплатный доступъ съ историей запросовъ и защитой отъ Zalgo.
          </p>
          <Link to="/api-setup" className="btn-professional px-8 py-2 mt-2 inline-block">
            Получить ключъ
          </Link>
        </div>
