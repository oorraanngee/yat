  ...
  return (
    ...
    >
      ...
      <div className="flex-grow">
        ...
        <span className="text-[10px] text-[#d4af37] uppercase tracking-widest mt-2 block">Читать далее →</span>
      </div>
    </Link>
  );
};
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <div className="text-center italic text-[#d4af37]">Загрузка Библиотеки...</div>
      </div>
    );
  }
              ...
              <div key={item.id}>
                {item.type === 'article' ? (
                  ...
                  >
                    ...
                    <span className="text-xs text-[#d4af37] mt-2 uppercase tracking-widest">Открыть статью →</span>
                  </Link>
                ) : (
