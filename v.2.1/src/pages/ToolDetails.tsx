...
import { LoremIpsum, IcaoTranslit, TextDiff, TextExtract, ReadTime, ListGenerator, TextMinify, SyllablesStressSynonyms } from '../components/tools/TextTools';
...
import { PercentCalc, CreditCalc, TaxCalc } from '../components/tools/MathTools';
import { DummyWhois, DnsCheck, IpInfo, UtmGen } from '../components/tools/NetTools';
import { RandNumber, RandItem, CookingConverter, DiceRoller, SysInfo, FileAnalyzer, TravelChecklist, KanbanBoard } from '../components/tools/LifeTools';
...
const TokenCalculator = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <label className="text-[10px] text-[#856a54] uppercase px-1 -mb-3 font-bold">Введите текст:</label>
            <textarea className="input-field h-40 resize-none w-full" value={text} onChange={e => setText(e.target.value)}/>
            <div className="grid grid-cols-2 gap-4 text-center mt-2">
                ...
                <div className="p-4 bg-[#1e130c] rounded border border-[#3d2b20]"><p className="text-[10px] text-[#856a54] uppercase">Примерно токенов</p><p className="text-[#d4af37] font-mono text-xl">{tokens}</p></div>
            </div>
        </div>
    );
};
