...
import { 
  ...
  AlignLeft, Settings, Clock, CheckSquare, Dices, TextCursorInput
} from 'lucide-react';
...
const categories = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'calc-tokens', name: 'Счетчик токенов GPT', icon: <Cpu size={18} /> },
  ...
  {
    title: 'Физика (и прочее)',
    icon: <Activity className="text-[#d4af37]" />,
    tools: [
      { id: 'conv-units', name: 'Метр/Грамм (Единицы)', icon: <Ruler size={18} /> },
  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="text-center">
        ...
        <p className="text-[#856a54] italic mb-4">Набор полезных сервисов {">"} 60 инструментов</p>
